...
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "")  # pode ficar vazio e usar /setchat
POLL_INTERVAL_MINUTES = int(os.getenv("POLL_INTERVAL_MINUTES", "30"))
MAX_ALERTS_PER_CYCLE = int(os.getenv("MAX_ALERTS_PER_CYCLE", "20"))
MCAP_MIN = int(os.getenv("MCAP_MIN", "10000000"))        # 10M
MCAP_MAX = int(os.getenv("MCAP_MAX", "100000000"))       # 100M
MIN_VOL_24H = float(os.getenv("MIN_VOL_24H", "500000"))  # USD
